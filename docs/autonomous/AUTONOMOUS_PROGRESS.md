...
| J | 安全、性能、降级与部署验证 | completed | current 139 tests；index约3.88MB；final p50/p95约465/584ms | 正式部署未授权 | `7a0451a`、`5a75b2b` |
...
| M | 10场景人工核验材料增强 | completed_with_limitations | 10/10含章节、上下文、角色、URL、5轮证据和5项确认；0条被程序核验 | 人工查看视频/游戏原文 | `45f38c5` |
| N | 8案例检索审核工作台 | completed_with_limitations | 8/8 gold URL Top 5、8/8引用完整；人工字段保持not_checked | 人工相关性与错误归因 | `5d95d62` |
...
| R | 第二轮稳定化交接 | completed | README、architecture、ADR、checklist、evaluation和第二轮报告 | 人工门仍未完成 | 当前文档提交 |
